...
class TestRetentionWindow(DeletionRetentionTestBase):
    ...
    def test_shared_value_overrides_env_and_is_used_by_task(self) -> None:
        """SC-PURGE-003 / FR-PURGE-004: a per-workspace shared value takes
    ...
    def test_upsert_is_idempotent(self) -> None:
        """T019: re-setting the window via upsert does not raise and keeps the
    ...
    def test_zero_disables(self) -> None:
        """SC-PURGE-003: a 0 shared value disables the time-based purge."""
